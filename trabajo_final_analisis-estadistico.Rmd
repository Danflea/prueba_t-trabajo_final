...
La población de este estudio está constituida por todas las instituciones educativas de la región de Ayacucho de la zona rural que imparten educación básica regular y tiene un tamaño de 722 alumnos.  
...
ggplot(data_rural_sin, aes(x = data_rural_sin$M500_EM_2S_2023_MA)) +
  ...
  labs(title = "Distribución Normal de la Población", x = "Nota", y = "Densidad") +
  theme_minimal()
```   
...
### Homogeneidad de Varianzas usando Bartlett {-}  
...
```{r tablasss, echo=FALSE, message=FALSE, warning=FALSE}
library(kableExtra)
